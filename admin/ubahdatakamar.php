                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Ubah Data Kamar <?php echo "$jenis"; ?></h3>
                                        </div>
                                        <hr>
                                        <form action="editkamar.php" method="post" novalidate="novalidate">
                                            <input type="hidden" name="jenis" value="<?php echo "$jenis"; ?>">
                                                <div class="form-group has-success">
                                                    ...
                                                    <input id="cc-name" value="<?php echo "$jumlah"; ?>" name="jumlah" type="text" class="form-control">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="cc-number" class="control-label mb-1">Harga Kamar</label>
