<?php
    ...
    $re = mysqli_query($koneksi,"select * from fasilitas");
    $ri   = mysqli_num_rows($re);
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand"><img src="images/bird.png" alt="Logo"></a>
                <a class="navbar-brand hidden"><img src="images/default.png" alt="Logo"></a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-id-home"></i><a href="fasilitas.php">Fasilitas</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count"><?php echo $ri; ?></span>
                        </h4>
