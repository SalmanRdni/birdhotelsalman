...
<head>
    ...
    <link rel="icon" href="images/logo2">
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand hidden"><img src="images/logo2" alt="Logo"></a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-id-kamar"></i><a href="fasilitas.php">Fasilitas</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                                ...
                                <table class="table">
                                    ...
                                    <?php
                                          ...
                                          while($d = mysqli_fetch_array($data)){
                                            ...
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                                                <td><a><img src="/reservasisalman/gambar/<?php echo $d['gambar'] ?>" width="100px"></a></td>
